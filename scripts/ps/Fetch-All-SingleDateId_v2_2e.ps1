<#
.SYNOPSIS
  Fetch-All-SingleDateId v2.2e — Full Runner (Parallel fix: no -ArgumentList)
  - 並行改為使用 $_ 取得符號；移除 -ArgumentList 以避免 ParameterSet 衝突
#>
...
# 定義：Sequential 路徑 per-symbol（顯式參數，避免 $using: 限制）
