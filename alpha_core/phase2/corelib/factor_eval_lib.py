...
"""
alpha_core.phase2.corelib.factor_eval_lib
...
- 真正「產生 / 更新 eval JSON」仍委託 alpha_core.phase2.corelib.factor_eval.evaluate_factors。
"""
...
# ---------------------------------------------------------------------------
# Evaluate helpers（呼叫本尊 alpha_core.phase2.corelib.factor_eval）
# ---------------------------------------------------------------------------
...
def evaluate_single_factor(
    ...
    等價於：
      1) alpha_core.phase2.corelib.factor_eval.evaluate_single_factor(...)
      2) 讀回 <root>/reports/factor_eval/<factor_id>_summary.json
    """
    if _evaluate_single_factor is None:
        raise RuntimeError("alpha_core.phase2.corelib.factor_eval.evaluate_single_factor is not available")
...
def evaluate_factors(
    ...
    if _evaluate_factors is None:
        raise RuntimeError("alpha_core.phase2.corelib.factor_eval.evaluate_factors is not available")
