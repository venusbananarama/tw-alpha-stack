...
CANDIDATES = ['C:/AI/tw-alpha-stack/src/alphacity/ingest/build_universe.py', 'C:/AI/tw-alpha-stack/scripts/build_universe.py', 'scripts/build_universe.py', 'tools/scripts/build_universe.py']
